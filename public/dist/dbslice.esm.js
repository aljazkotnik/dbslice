...
class ordinalAxis{
	...
	draw(){
		...
		let d3axis = obj.axis == "y" ? d3$2.axisLeft : d3$2.axisBottom;
...
class twoInteractiveAxesInset{
	...
	addZooming(){
		...
		obj.viewtransform = d3$2.zoomIdentity;
