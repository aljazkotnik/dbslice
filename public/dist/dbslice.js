(function () {
  ...
  */
  ...
  var template$1 = /*#__PURE__*/function () {
    ...
    _createClass$1(template, [{
      ...
      value: function backbone() {
        return "\n\t\t<div style=\"".concat(css$1.fullscreenContainer + "display: none;", "\">\n\t\t<div style=\"").concat(css$1.card, "\">\n\t\t  <div>\n\t\t\t<div>\n\t\t\t  \n\t\t\t  <div>\n\t\t\t\t<h2 style=\"display: inline;\">Metadata merging:</h2>\n\t\t\t\t<button style=\"").concat(css$1.btn + "float: right;", "\">\n\t\t\t\t  <i class=\"fa fa-exclamation-triangle\"></i>\n\t\t\t\t</button>\n\t\t\t  </div>\n\t\t\t  \n\t\t\t  <div class=\"legend\">\n\t\t\t    <div>\n\t\t\t\t</div>\n\t\t\t  </div>\n\t\t\t  \n\t\t\t</div>\n\t\t  </div>\n\t\t  \n\t\t  \n\t\t  <div class=\"body\" style=\"overflow-y: scroll; overflow-x: scroll; height: 400px;\">\n\t\t\t<div></div>\n\t\t  </div>\n\t\t  \n\t\t  \n\t\t  \n\t\t  <div>\n\t\t\t<button class=\"submit\" style=\"").concat(css$1.btn + "background-color: mediumSeaGreen; color: white;", "\">Submit</button>\n\t\t  </div>\n\t\t  \n\t\t</div>\n\t\t</div>");
      } // app
      ...
      function draggablebutton(variableobj) {
        ...
        var cssstyle = css$1.btnPill + css$1.btnDraggable + "background-color: ".concat(obj.color(variableobj.category), ";");
      ...
      value: function legendbutton(category) {
        var obj = this;
        var cssstyle = css$1.btnPill + css$1.btnLegend + "background-color: ".concat(obj.color(category), ";");
      ...
      value: function ghostbutton(classnames) {
        var cssstyle = css$1.btnPill + css$1.btnGhost;
    ...
    _createClass$1(variabledrag, [{
      ...
      value: function reposition(container) {
        ...
        function move(a, container, b) {
          ...
          var originghost = template$1.html2element(template$1.ghostbutton());
  ...
  var metadatamerger = /*#__PURE__*/function () {
    function metadatamerger(files) {
      ...
      obj.files = files; // It will need to keep track of the merging information. Maybe it should be a property of this object actually

      obj.merging = []; // Maje the html builder and get a node to attach to the html app.
    ...
    _createClass$1(metadatamerger, [{
      ...
      value: function submit() {
        ...
        obj.hide(); // Redo the menu for the next appearance.
  ...
  */
  ...
  var errorreport = /*#__PURE__*/function () {
    ...
    _createClass$1(errorreport, [{
      ...
      value: function update() {
        ...
        var body = obj.node.querySelector("div.body");
        body.lastChild.remove();
        var content = html2element(template.content(obj.errors));
  ...
  var mergerer = new metadatamerger(library.files);
  ...
  var errorreporter = new errorreport(errorfiles);
