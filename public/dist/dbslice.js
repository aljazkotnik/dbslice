(function () {
  ...
  var template$2 = /*#__PURE__*/function () {
    ...
    _createClass$1(template, [{
      ...
      value: function backbone() {
        return "\n\t\t<div>\n\t\t  <div class=\"legend\">\n\t\t    <div>\n\t\t\t</div>\n\t\t  </div>\n\t\t \n\t\t  <div class=\"body\" style=\"overflow-y: scroll; overflow-x: scroll; height: 400px;\">\n\t\t\t<div></div>\n\t\t  </div>\n\t\t  \n\t\t  <div>\n\t\t\t<button class=\"submit\" style=\"".concat(css$2.btn + "background-color: mediumSeaGreen; color: white;", "\">Submit</button>\n\t\t  </div>\n\t\t</div>  \n\t\t");
      } // app
  ...
  */
  ...
  var metadatamanager = /*#__PURE__*/function () {
    function metadatamanager(files) {
      _classCallCheck(this, metadatamanager); // The `datastore' object is responsible for tracking all the data changes and selections. It does not hold any information regarding the session, and about any plots made with the data.


      var obj = this;
      obj.files = files; // Make the class observable.
      ...
      var container = obj.node.querySelector("div.menu-body"); // Make the modules that need access to the DOM.

      obj.merger = new metadatamerger([]);
      container.appendChild(obj.merger.node);
      console.log(obj.merger);
      obj.errorreport = new errorreport(obj.errors); // Should it be controlled here??
    ...
    _createClass$1(metadatamanager, [{
      ...
      key: "update",
      value: function update() {
        var obj = this; // This should ONLY run when the merge info changes.
        ...
        console.log("Use merging info to create metadata and update crossfilter", obj.merger.merginginfo); // Hide the menu.
  ...
  */
  ...
  var M = new metadatamanager(library.files);
