...
export function indexOfObjectByAttr(array, attr, value) {
...
export function findObjectByAttribute(A, attribute, values, flag){
...
export function collectObjectArrayProperty(A, attribute){
...
// Text sizing
export function fitTextToBox(text, box, dim, val){
